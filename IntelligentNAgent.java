...
public class IntelligentNAgent extends Agent {
    ...
    public double dEpsilon = 0.9; // el 90 % de las veces cogerá el mas probable				
    ...
    private class Play extends CyclicBehaviour {
                ...
                switch (state) {
                    ...
                    case s2Round:
                        ...
                        if (msg.getPerformative() == ACLMessage.REQUEST /*&& msg.getContent().startsWith("Position")*/) {
                            ...
                            if(matrizcargada){
                                 seleccion=filaMasProbable(QValues);
                            }else{
        ...
        public void QLearning(int valor, int fila){
            ...
            QValues[fila] = (float)(QValues[fila] + dLearnRate * (reward + y - QValues[fila]));
          ...
          private int filaMasProbable(float[] numbers)
        {
            ...
            if(Math.random()>dEpsilon){ // un 10% de las veces no elegirá la mas probable
